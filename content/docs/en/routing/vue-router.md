...
> Currently, integration with Vue Router is **unsupported**. Please use [manual routing](/en/docs/routing/manual-routing) until we figure out the deal with VueRouter - it might take a while.
